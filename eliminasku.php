...
function setfocus(){
    document.getElementById("ubica").focus();
}
</script>
...
<div>
	<form name = "formusuario" action="eliminasku1.php" method="POST" >
		<table align= "center" border: "red 5px solid ">
    	<tr >
    		<td id= "label">Id: </td> 
    	...
    	<tr>
			...
			<td id= "box"> <input  name="ubi" type="hidden" id= "ubi" type="text" size = "30" value= "<?php echo TRIM($ubica) ?>"> </td>
    	</tr>			
		<tr>
		  <td id="label"></td>
		  <td id="label" >   Eliminar
      	  <input   name="submit" id="submit" value="Grabar" src="assets\img\delete.png" type="image" > 
