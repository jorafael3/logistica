...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					<div id = "izq" >  </div>
					<div id = "centro" > <a class="titulo"> <center>   Datos de Entrega   </center> </a></div>
...
<?php 
			...
			//Select Query
			$result = $pdo->prepare("select id, Detalle, Secuencia from ven_facturas f with(nolock)
									 inner join facturaslistas fl with(nolock) on fl.factura = f.id 
									 where fl.transporte = 'Vehiculo Computron' and f.secuencia=:secu" );
...
<div>
	<form name = "formusuario" action="entregarfacturas1.php" method="POST" >
		...
		<tr>
			...
			<td id= "box"> <input  name="chofer" id= "chofer" type="text" size = "30" value= " "> </td>
    	</tr>		
		<tr>
    		<td id= "label">Placa Camion: </td> 
			<td id= "box"> <input  name="placa" id= "placa" type="text" size = "30" value= " "> </td>
    	</tr>
		<tr>
