...
<div>
	<form name = "formproducto" action="facturasanuladas.php" method="POST" width="75%">
		...
		<div class=\"table-responsive-xs\">
			<form name = "formfactura2" width="100%">
				<table align ="center" >
					<tr>
						<th colspan="6">  </th> 
					</tr> 
...
<?php
		...
		?>					
								<tr>
									<td id= "fila4"  > <a href ="trakingfacturasanuladas0.php?secu=<?php echo $arreglodesp[$y][2]?>&bodegaFAC=<?php echo $arreglodesp[$y][7]?>"> <?php echo $arreglodesp[$y][1] ?></a></td> 
