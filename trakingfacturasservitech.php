		    ...
		    if (isset($_SESSION['loggedin']))
				{	
				   ...
				   // $codigo= trim($codigo);
					...
					$result1->bindParam(':bodega',$BodegaId,PDO::PARAM_STR);
...
<div align= "center" width= 100%>
	<table border=2 width=100% id= "traking">
		<tr> 
			...
			<td id="label5" colspan = "2" align= "right"> <a href= "consultarseriesservitech2.php?factid=<?php echo $Id ?>" > CONSULTAR SERIES </a></td>
		</tr>
		<tr>
		...
		<tr>
			<td id="td1"> <strong> Vendedor: </strong> </td> <td id="label4"> <a> <?php echo $vendedor ?> </a> </td>
			<td id="td1"> <strong> F.Pago: </strong> </td> <td id="label4" colspan = "3"> <a> <?php echo $FPago ?> </a> </td>
		</tr>
		<tr>
			<td id="td1"> <strong> Fecha Factura: </strong> </td> <td id="label4"> <a> <?php echo $Fecha ?> </a> </td>
			<td id="td1"> <strong> Nota: </strong> </td> <td colspan = "3" id="label4"> <a> <?php echo $Observacion ?> </a> </td>
		</tr>		
		<tr>
			<td id="td1"> <strong> Preparado: </strong> </td> <td id="label4"> <a> <?php echo $PREPARADOPOR ?> </a> </td> 
			<td id="td1"> <strong> Fecha Preparado: </strong> </td> <td id="label4" colspan = "3"> <a> <?php echo $FECHAYHORA ?> </a> </td> 
		</tr>
		<tr>
			<td id="td1"> <strong> Verificado: </strong> </td> <td id="label4"> <a> <?php echo $VERIFICADO ?> </a> </td> 
			<td id="td1"> <strong> Fecha Verificado: </strong> </td> <td id="label4" colspan = "3"> <a> <?php echo $FECHAVERIFICADO ?> </a> </td>
		</tr>
		<tr>
			<td id="td1"> <strong> Ingreso Guia: </strong> </td> <td id="label4"> <a> <?php echo $GUIAPOR ?> </a> </td>
			<td id="td1"> <strong> Fecha Guia : </strong> </td> <td id="label4" colspan = "3"> <a> <?php echo $FECHAGUIA ?> </a> </td>
		</tr>
		<tr>
			<td id="td1"> <strong> Transporte: </strong> </td> <td id="label4">  <a> <?php echo $TRANSPORTE ?> </a> </td>
			<td id="td1"> <strong> Guia#: </strong> </td> <td id="label4"> <a> <?php echo $GUIA ?> </a> </td>
			<td id="td1"> <strong> Bultos#: </strong> </td> <td id="label4"> <a> <?php echo $BULTOS ?> </a> </td>
		</tr>
		<tr>
			<td id="td1"> <strong> Despachado: </strong> </td> <td id="label4">  <a> <?php echo $DESPACHADO ?> </a> </td>
			<td id="td1"> <strong> Fecha Desp.: </strong> </td> <td id="label4" colspan = "3"> <a> <?php echo $FECHADESPACHADO ?> </a> </td>
		</tr>
		<tr>
			<td id="td1"> <strong> Comentario Despacho: </strong> </td> <td id="label4" colspan= "5">  <a> <?php echo $lcomentario ?> </a> </td>
		</tr>
		<tr>
			<td id="td1"> <strong> Entregado Vehiculo: </strong> </td> <td id="label4">  <a> <?php echo $vehiculoPor   ?> </a> </td>
			<td id="td1"> <strong> Chofer: </strong> </td> <td id="label4" > <a> <?php echo $Chofer ?> </a> </td>
			<td id="td1"> <strong> Placa: </strong> </td> <td id="label4" > <a> <?php echo $placa ?> </a> </td>
		</tr>
		<tr>
			<td id="td1"> <strong> Fecha Des. Vehiculo: </strong> </td> <td id="label4"  > <a> <?php echo $FechaVehiculo ?> </a> </td>
			<td id="td1"> <strong> Comentario Vehiculo: </strong> </td> <td id="label4"  colspan= 3> <a> <?php echo $ComentarioVeh ?> </a> </td>
		</tr>
    </table>	
...
?>		
	...
	<table border=2 width=100% id= "traking">
		<tr>										 
			<td id="ruta" width="50%"  ><a href="<?php echo ?>" target="_blank"> PDF_Factura </a> </td>
			<td id="td1"> <strong> Subtotal: </strong> </td> <td id="label5" > <a> <?php echo $Subtotal ?> </a> </td>
		</tr>
		<tr>
			<td id="label2" width="50%">  </td>	
			<td id="td1"> <strong> Descuento: </strong> </td> <td id="label5"> <a> <?php echo $Descuento ?> </a></td>
		</tr>
		<tr>	
			<td id="label2" width="50%">  </td>
			<td id="td1"> <strong> Financiamiento: </strong> </td> <td id="label5"> <a> <?php echo $Finan ?> </a></td> 
		</tr>
		<tr>	
			<td id="label2" width="50%">  </td>
			<td id="td1"> <strong> Impuesto 12%: </strong> </td> <td id="label5"> <a> <?php echo $Impuesto ?> </a></td> 
		</tr>
		<tr>	
			<td id="label2" width="50%">  </td>
			<td id="td1"> <strong> Total: </strong> </td> <td id="label5"> <a> <?php echo $Total ?> </a></td> 
		</tr>		
	</table>	
