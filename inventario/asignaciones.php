...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					<div id = "izq" ></div>
					<div id = "centro" > <a class="titulo"> <center>   Inventarios por asignar diferencia  </center> </a></div>
		...
		<table id= "listado" align ="center" > 
				...
				?>
							<tr> 
								...
								<td id= "fila" align=center> <a href="asignardiferencias.php?id=<?php echo $arreglo[$y][1] ?>"><?php echo $arreglo[$y][2] ?></td> 
							</tr>
				<?php
						$y=$y+1;			
						}	
