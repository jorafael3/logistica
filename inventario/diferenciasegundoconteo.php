...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					...
					<div id = "izq" >  </div>
					<div id = "centro" > <a class="titulo"> <center>   Diferencias de Segundo Conteo   </center> </a></div>
...
<div>
	<form name = "forminven" action="diferenciasegundoconteo1.php" method="POST" >
		<table  >
			<tr> 
			</tr>
			<tr>
...
<?php
				...
				$result = $pdo->prepare('select * from inv_conteo where estado = :estado and Conteo2=:con');	
				$result->bindParam(':estado',$estado,PDO::PARAM_STR);					
				$result->bindParam(':con',$con,PDO::PARAM_STR);	
				$result->execute();
