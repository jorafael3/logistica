...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					<div id = "izq" ></div>
					<div id = "centro" > <a class="titulo"> <center>   Inventarios en Curso  <?php echo substr($nomsuc,10,20); ?> </center> </a></div>
		...
		<table id= "listado" align ="center" > 
				...
				?>
							<tr> 
								...
								<td id= "fila" align=center> <a href="inventario0.php?id=<?php echo $arreglo[$y][1] ?>"><?php echo $arreglo[$y][2] ?></td> 
							</tr>
				<?php
						$y=$y+1;			
						}	
