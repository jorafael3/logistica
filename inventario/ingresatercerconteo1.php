							...
							while ($row = $result->fetch(PDO::FETCH_ASSOC)) 
								  {	  
									...
									$result1 = $pdo1->prepare("select isnull (sum(cantidad),0) as cant  from INV_CONTEO_PRODUCTOS
															   where ConteoID=:ConteoID and id=:pid  and NombreSeccion=:seccion
															   and CodigoBarras =:codbarras group by codigobarras");
...
?>		
	<div id="cuerpo2" >
					...
					<div id = "izq" > </div> 
					<div id = "centro" > <a class="titulo"> <center> 3er Conteo <?php echo $cod ?> </center> </a></div>
...
<?php
					...
					while ( $y <= $count2-1 ) 
					{
						...
						if ($arreglo[$y][1]== null) 
							...
							$ubic= $arreglo[$y][1];}				 
?>					<form name = "forminven" action="ingresatercerconteo2.php" method="POST" >
						<tr> 
...
?>		
			<tr>
				<td> </td>
				<td id="label" align=center><a href="ingresatercerconteo1.php?pid=5" style="text-decoration:none"> + Ubicacion </a></td>
			</tr>
			<tr>
				<td> </td>
				<td id="label" align=center><a href="tercerconteo.php" style="text-decoration:none">Regresar</a></td>
			</tr>
...
<?php
		if ($activar=="si"){?>
			<div>
				<form name = "formusuario" action="agregarskuconteo2.php" method="POST" width="75%">
					<table align ="center" >
						<tr> 
