...
//ini_set('display_errors','On');
		    ...
		    if (isset($_SESSION['loggedin']))
				{	
					...
					$result = $pdo->prepare('LOG_Inventario_Segundo_Conteo @Usuario=:usuasignado , @Estado=:estado , @seccion=:conteo');		 
...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >			 
			<div id = "izq" >  </div>
			<div id = "centro"> <a class="titulo"> <center>  <?php echo $count. " items 2do Conteo " ?>   </center> </a></div>
		...
		<table id= "listado" align ="center" > 
				...
				<?php
						...
						while ( $y <= $count-1 ) 
						{
							...
							if ($arreglo[$y][9]==0 and $arreglo[$y][8]<>0 ){$colorf="lightblue";}else{$colorf="lightpink";}}
				?>
							<tr bgcolor="<?php echo $colorf ?>">
								<td id= "fila"><a href="ingresasegundoconteo1.php?pid=<?php echo $arreglo[$y][6] ?>"> <?php echo $arreglo[$y][2] ?></a></td> 
