	                        ...
	                        <div class="col-md-8">
	                            <div class="card">
	                                <div class="card-header">
	                                    <h4 class="card-title">RMA- Orden de Servicio</h4>
																			<h6>Tipo: ORD-SER</h6>
	                                </div>
	                                <div class="card-body">
                                    <div class="row">
	                                        ...
	                                        <div class="row">
	                                            <div class="col-md-5 pr-1">
	                                                <div class="form-group">
	                                                    ...
	                                                    <input id="producto" name="producto" type="text" class="form-control" placeholder="Producto" value="">
	                                                </div>
	                                            </div>
	                                            ...
	                                            <div class="col-md-3 pl-1">
	                                                <div class="form-group">
                                                      ...
                                                      <select id="marca" class="form-control" name="marca"></select>
	                                                </div>
	                                            </div>
	                                        </div>
																					<div class="row">
																							<div class="col-md-5 pr-1">
																									<div class="form-group">
																											<label>Serie</label>
																											<input id="serie" name="serie" type="text" class="form-control" placeholder="Serie" value="">
																									</div>
																							</div>
																							<div class="col-md-4 px-1">
																									<div class="form-group">
