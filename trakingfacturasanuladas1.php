		    ...
		    if (isset($_SESSION['loggedin']))
				{	
				   ...
				   // $codigo= trim($codigo);
					...
					//Select Query
					$result = $pdo->prepare('LOG_BUSQUEDA_FACTURA @secuencia=:secu , @bodegaFAC=:bodegaFAC');		 
...
<div align= "center" width= 100%>
	<table border=2 width=100% id= "traking">
		<tr> 
			...
			<td id="td1" width="10%"> <strong> Fact.#: </strong> </td> <td id="label4"> <a> <?php echo $Secuencia ?>  </a></td>  
		...
		<tr>
			...
			<td id="td1"> <strong> F.Pago: </strong> </td> <td id="label4" colspan = "3"> <a> <?php echo $pagsis ?> </a> </td>
		</tr>
		<tr>
		...
		<tr>
			<td id="td1"> <strong> Comentario Devolucion: </strong> </td> <td id="label4" colspan= "5">  <a> <?php echo rtrim(ltrim($DNota)) ?> </a> </td>
		</tr>
    </table>	
...
?>		
	...
	<table border=2 width=100% id= "traking">
		<tr>										 
			<td id="ruta" width="50%"  ><a href="pdffactura.php?aut=<?php echo $ruta ?> " target="_blank"> PDF Factura  </a> </td>
	...
	<form name = "formpreparar" action="#" method="POST" width="75%">
		<table align ="center" >
			<tr>
						...
						<a href="facturasanuladas.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar</a> 
