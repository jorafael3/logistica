		    ...
		    if (isset($_SESSION['loggedin']))
				{	
				   ...
				   // $codigo= trim($codigo);
					...
					$result->bindParam(':numero',$transfer,PDO::PARAM_STR);
					$result->execute();
					...
					$result1->bindParam(':numero',$transfer,PDO::PARAM_STR);
					...
					$result2 = $pdo2->prepare('SELECT TransferenciasID FROM INV_TRANSFERENCIAS_AGRUPADAS WHERE AgruparID=:transfer');		 
					$result2->bindParam(':transfer',$transfer,PDO::PARAM_STR);
					$result2->execute();
					while ($row2 = $result2->fetch(PDO::FETCH_ASSOC)) 
						{
							$numtransfer= $numtransfer + $row2['TransferenciasID']; 
						}
...
<div align= "center" width= 100%>
	<table border=2 width=100% id= "traking">
		<tr> 
			...
			<td id="td1" > <strong> BODEGA DESTINO : </strong> </td> <td id="label4" colspan = "2"> <a> <?php echo $Descodigo ."  ". $Destino ?></a></td>
			   			
		</tr>
		<tr>
			<td id="td1"> <strong> Transf.Agrup.: </strong> </td> <td id="label4"> <a> <?php echo $Idtransfer ?> </a> </td>
			<td id="td1"> <strong> Fecha : </strong> </td> <td id="label4" colspan = "2"> <a> <?php echo $Fecha ?> </a> </td>
		  	
		</tr>
    	<tr>
			<td id="td1"> <strong> Detalle: </strong> </td> <td id="label4" colspan= "4"> <a> <?php echo $Detalle ?> </a> </td>
		...
		<tr>
			<td id="td1"> <strong> Ing.Guia Por  : </strong> </td> <td id="label4"> <a> <?php echo $GUIAPOR ?> </a> </td> 
		...
		<tr>
			<td id="td1"> <strong> Comentario Desp.: </strong> </td> <td id="label4" colspan= "4"> <a> <?php echo $COMENTARIO ?> </a> </td> 	
		</tr>
		<tr>
			<td id="td1"> <strong>Transferencias Agrupadas: </strong> </td> <td id="label4" colspan= "4"> <a> <?php echo $numtransfer ?> </a> </td> 	
		</tr>
    </table>
</div>	
...
?>		
	...
	<form name = "formpreparar" action="#" method="POST" width="75%">
		<table align ="center" >
			<tr>
				<td>	<a href="despachartransferencias.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar</a> </td>
			</tr> 
		</table>
	</form>
