...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					...
					<div id = "izq" > </div>
					<div id = "centro" > <a class="titulo"> <center>   Modificar Series Transferencias <?php echo substr($nomsuc,10,20); ?> </center> </a></div>
...
<div id= "cuerpo2" align= "center" >
			...
			<div>
				<form name = "formserie" action="modificarseriestransfer0.php" method="POST" width="75%">
					<table align ="center" >
					<tr>
						<td id="label" >Transferencias # </td> 
