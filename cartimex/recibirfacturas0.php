	...
	if (isset($_SESSION['loggedin']))
		{
			...
			//Select Query
			$result1 = $pdo1->prepare('LOG_FACTURAS_PENDIENTES_POR_RECIBIR @secuencia=:secu, @bodega=:bodega, @acceso =:acceso, @bodegaFAC=:bodegaFAC');		 
			...
			if ($count<0)
				{	
					 ...
					 if ($row1['nombre']==""){
						header("location: recibirfacturas2.php"); }	
					 else
					 {
