...
<div align= "center" width= 100%>
	<table border=2 width=100% id= "traking">
		...
		<tr>
			<td id="td1"> <strong> Guia o Placa: </strong> </td> <td id="label4"> <a> <?php echo $GUIA ?> </a> </td> 
			<td id="td1"> <strong> Transporte: </strong> </td> <td id="label4" colspan = "2"> <a> <?php echo $TRANSPORTE ?> </a> </td> 
			
		</tr>
		<tr>
			<td id="td1"> <strong> Comentario Despacho: </strong> </td> <td id="label4" > <a> <?php echo $lcomentario ?> </a> </td> 
			<td id="td1"> <strong> Bultos: </strong> </td> <td id="label4" colspan= "2"> <a> <?php echo $BULTOS ?> </a> </td> 
		</tr>
    </table>
</div>	
...
?>		
	...
	<form name = "formpreparar" action="#" method="POST" width="75%">
		<table align ="center" >
			<tr>
				<td>	<a href="entregarfacturas.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar</a> </td>
			</tr> 
		</table>
	</form>
