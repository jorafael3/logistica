...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					...
					<div id = "izq" > </div>
					<div id = "centro" > <a class="titulo"> <center>   Ensambles Pendientes  </center> </a></div>
...
<div id= "cuerpo2" align= "center" >
		...
		<div class=\"table-responsive-xs\">
			<form name = "formfactura2" action="ensamblarfactura.php" method="POST" width="100%">
			<table align ="center" >
				<tr>
		...
		<?php
				            ...
				            $result = $pdo->prepare("select 
													Bo.Código, F.Detalle , F.Secuencia, FechaF = CONVERT( char(10), f.fecha, 103) ,  FechaRecibido,  e.EnsambleId, e.Tipo
													...
													AND F.ID IN (SELECT FacturaId FROM INV_PRODUCCION_ENSAMBLE WITH (NOLOCK)  WHERE tipo = 'VEN-FA' and Estado= 'RECIBIDO' )   
													GROUP BY Bo.Código,F.Detalle ,  F.Secuencia, F.Fecha, FechaRecibido, e.EnsambleId, e.Tipo
