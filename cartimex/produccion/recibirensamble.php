...
//ini_set('display_errors','On');
		...
		if (isset($_SESSION['loggedin']))
			{	
					...
					$resultdt = $pdodt->prepare('select p.Código, p.Nombre, dt.Cantidad  
					...
					?>
						<tr> 
							...
							<td id= "fila" align=left> <?php echo $arreglo[$y][3] ?></td> 
 							<td id= "box"> <input name="checkbox[]" type="checkbox" value ="<?php echo $n ?> "  > </td>	
						</tr>
					<?php						
					$y=$y+1;
					$n=$n+1;
...
?>		 		
			...
			<table  border="2" cellpadding="5" cellspacing="1">
				<tr>
					<td id="label" >Maquinas a ensamblar: </td> 
					<td id= "box"> <Input Type= Number Size = 10 Maxlenght=5 Name='cant' id='cant' min='1' max='2000' required> </td>
				</tr>
				<tr>	
					<td colspan="2" align= "center"> <input id="submit" value=" Recibir productos para ensamblar " type="submit"></td>
				</tr>
