...
<div align= "left">
	<table>
		<tr><td><strong> BODEGA : <a> <?php echo $Codbodega ?>	</strong></td></tr>
		<tr><td id="label2">
...
<div id="cuerpo2" align= "center">
	<div>
		<form name = "modificarseries" action="modificarseries3.php" method="POST" width="75%">
			<table id= "listado2" align ="center" > 
				...
				?>
							<tr> 
								...
								<td id= "box"> <input name="serie[]" type="text" id="serie[]" value= "<?php echo trim($ser.$arreglo[$y][6]) ?>"> </td>
								<input  name="dtid[]" type="hidden" id="dtid[]" value="<?php echo $arreglo[$y][1] ?>"  >
								<td id= "fila" align=left>  <?php echo $arreglo[$y][1] ?> </td>
