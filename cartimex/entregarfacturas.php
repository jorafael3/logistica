...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					...
					<div id = "izq" > </div>
					<div id = "centro" > <a class="titulo"> <center>   Entregar Facturas  <?php echo substr($nomsuc,10,20); ?> </center> </a></div>
...
<div id= "cuerpo2" align= "center" >
			...
			<div>
				<form name = "formfactura" action="entregarfacturas0.php" method="POST" width="75%">
					<table align ="center" >
					<tr>
		...
		<div class=\"table-responsive-xs\">
			<form name = "formfactura2" action="entregarfacturas0.php" method="POST" width="100%">
			<table align ="center" >
				<tr>
					<th colspan="7">Facturas Por Entregar </th> 
				</tr> 
				<tr> 
		...
		<?php
							...
							$result = $pdo->prepare("LOG_FACTURAS_PENDIENTES_ENTREGA @BODEGA=:bodega , @acceso=:acceso" );		 
		...
		?>						
								<tr>
									<td id= "fila4"  > <a href ="trakingentregar.php?secu=<?php echo $arreglo[$y][2]?>"><?php echo $arreglo[$y][1] ?> </a></td> 
