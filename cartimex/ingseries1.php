	...
	if (isset($_SESSION['loggedin']))
		{
			...
			$usuario1= $usuario; 
			//echo $usuario. $base. $acceso. $idproducto. $factura. $cantseries;
			...
			while ($x <$cantseries)
				{
					...
					//echo "Esto es lo que voy a insertar". $factura. $series[1][$x].$fecha.$idproducto. "Grabar". $grabar ; 
					...
					$result->bindParam(':FACTURAID',$factura,PDO::PARAM_STR);
			...
			header("Refresh: 0 ; verificarfacturas2.php");
		}
	else
		{
