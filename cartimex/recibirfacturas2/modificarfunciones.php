...
if (isset($_POST['validar_serie'])) {
    $serie = $_POST['serie'];
    $ProductoId = $_POST['ProductoId'];
    $query = $pdo->prepare("SELECT bd = 'COMPUTRONSA',se.*,Estado = isnull(r.Estado,'NO-RMA'),FacturaID = isnull(r.FacturaID,'') from 
    CARTIMEX..INV_PRODUCTOS_SERIES_COMPRAS se with(NOLOCK)
