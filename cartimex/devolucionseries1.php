...
<div id="cuerpo2" align= "center">
	<div>
		<form name = "formfactura2" action="devolucionseries2.php" method="POST" width="75%">
			<table id= "listado2" align ="center" > 
				...
				?>
							<tr> 
								...
								<td id= "fila2" align=left>  <?php echo $arreglo[$y][6] ?></td> 
								<td id= "box"> <input name="checkbox[]" type="checkbox" value ="<?php echo $arreglo[$y][6] ?>" > </td>	
							</tr>
				<?php
							$y=$y+1;			
						}
			...
			<input   id="submit" value=" Devolver Series Marcadas " type="submit">
		</form>
	</div>	
