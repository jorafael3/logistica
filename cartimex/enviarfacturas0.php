...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					<div id = "izq" >  </div>
					<div id = "centro" > <a class="titulo"> <center>   Finalizar Envio de Factura </center> </a></div>
...
<?php
			...
			//Select Query
			$result = $pdo->prepare("select f.id, Detalle, Secuencia, guia, transpor= '' , chofer, placa from ven_facturas f with(nolock)
									 inner join facturaslistas fl with(nolock) on fl.factura = f.id
									 where fl.ESTADOENVIO = 'POR ENVIAR' and f.secuencia=:secu" );
...
<div>
	<form name = "formusuario" action="enviarfacturas1.php" method="POST" >
		<table align= "center" >
    	<tr >
		...
		<tr>
			...
			<td id= "box"> <input  name="transporte" id= "transporte" type="text" size = "30" value= "<?php echo $transporte ?>"   > </td>
    	</tr>
		<tr>
    		<td id= "label">Guia:  </td>
		...
		<tr>
		  ...
		  <a href="enviarfacturas.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar    	</a>
		  </td>
		 </tr>
      </table>
    </form>
 ...
 <?php
    ...
    $_SESSION['tipodespacho']= $tipodespacho;
		...
		<?php
			header("Refresh: 1 enviarfacturas.php");
		}
		}
		else
		{
