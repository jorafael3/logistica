				...
				{	
				   ...
				   // $codigo= trim($codigo);
					...
					while ($row1 = $result1->fetch(PDO::FETCH_ASSOC)) 
					{
						...
						$PREPARAJAULADOPOR= $row1['PREPARAJAULADOPOR'];
						$FECHAJAULA= $row1['FECHAJAULA'];
...
<div align= "center" width= 100%>
	<table border=2 width=100% id= "traking">
    	...
    	<tr>
			<td id="td1"> <strong> Cliente: </strong> </td> <td id="label4" colspan= "3"> <a> <?php echo $Nombre ?> </a> </td>
		</tr>		
		<tr>
		...
		<tr>
			<td id="td1"> <strong> Preparado Jaula: </strong> </td> <td id="label4"> <a> <?php echo $PREPARAJAULADOPOR ?> </a> </td> 
			<td id="td1"> <strong> Fecha Preparado Jaula: </strong> </td> <td id="label4" colspan = "2"> <a> <?php echo $FECHAJAULA ?> </a> </td> 
		</tr>
    </table>	
...
?>		
	...
	<form name = "formpreparar" action="#" method="POST" width="75%">
		<table align ="center" >
			<tr>
				<td>	<a href="verificarfacturas.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar</a> </td>
			</tr> 
		</table>
	</form>
