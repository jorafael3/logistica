								...
								while ($row0 = mysqli_fetch_array($result0)) 
									{
									   ...
									   if ($Transporte== 'Urbano') { $rastreo = 'www.urbano.com.ec/';}
									   if ($Transporte=='Tramaco') { $rastreo = 'www.tramaco.com.ec/';}
									   if ($Transporte== 'Servientrega') { $rastreo = 'www.servientrega.com.ec/rastreo/multiple';}
									}
