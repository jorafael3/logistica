...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					<div id = "izq" >  </div>
					<div id = "centro" > <a class="titulo"> <center>  Recibir Factura </center> </a></div>
...
<div align= "left">
	<form name = "formusuario" action="recibirfacturasguias1.php" method="POST" >
		<table>
    	<tr>
      ...
      <tr>
  		...
  		<tr>
      		<td id= "label2">Factura #: </td><td><a> <?php echo $secuencia ?> </a></td>
			<td id= "box"> <input name="secu" type="hidden" id="secu" size = "30" value= "<?php echo $secuencia ?>"> </td>
    	</tr>
    	<tr>
    		<td id= "label2">Cliente: </td><td><a> <?php echo $detalle ?> </a></td>
    	</tr>
      <tr>
    ...
    <table align= "center" >
        ...
        <td>	<a href="ingguiasfacturas.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar</a> </td>
  		 </tr>
     </table>
    </form>
 ...
 <?php
  ...
  // <a href="entregarfacturas.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar    	</a>
		...
		<?php
			header("Refresh: 1 recibirfacturasguias.php");
		}
		}
		else
		{
