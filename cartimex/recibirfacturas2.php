...
<link href="../estilos/estiloRecibirFactura.css" rel="stylesheet" type="text/css">
	...
	<div id="Cuerpo">
		<div id="cuerpo2">
			...
			<div id="centro"> <a class="titulo">
					<center> Recibir Facturas <?php echo substr($nomsuc, 10, 20); ?> </center>
				</a></div>
		...
		<div id="cuerpo2" align="center">
			<div class="form-container">
				<form name="formproducto" action="verificarfacturas0.php" method="POST">
					<table class="modern-table">
						<tr>
							<td class="form-label"> # Factura Recibida:</td>
							<td class="form-input">
								<input name="secu" type="text" id="secu" size="30" value="">
								<input name="bodega" type="hidden" id="bodega" size="30" value="<?php echo trim($bodega) ?>">
							</td>
						</tr>
						<tr>
							<td class="refresh-icon"><a href="javascript:window.location.href=window.location.href"><img src="..\assets\img\refresh.png" alt="Refresh"></a></td>
							<td class="form-input" style="text-align: center;">
								<input name="submit" id="submit" value="Grabar" src="..\assets\img\lupa.png" type="image">
								<span class="button-label">Consultar</span>
							</td>
						</tr>
						<tr>
				...
				<form name="formproducto_d" action="#" method="POST">
		...
		?>
			<div id="btnContainer">
				<button id="btnExport" id="ecxel" onclick="htmlTableToExcel('xlsx')">Exportar a excel</button>
			</div>
			<br>
			<div class=\"table-responsive-xs\">
				<form name="formfactura2" action="verificarfacturas0.php" method="POST" width="75%">
					<table align="center" id="Tabla_facturas">
						...
						$result = $pdo->prepare("LOG_FACTURAS_PENDIENTES_POR_RECIBIR @BODEGA=:bodega , @acceso=:acceso");
						...
						?>
							<tr>
								<td id="fila4"> <a href="trakingrecibir.php?secu=<?php echo $arreglo[$y][2] ?> "> <?php echo $arreglo[$y][1] ?> </a> </td>
