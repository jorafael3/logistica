...
<div align= "center" width= 100%>
	<table border=2 width=100% id= "traking">
		<tr> 
			...
			<td id="label5" colspan = "2" align= "right"> <a href= "consultarseries.php?factid=<?php echo $Id ?>" target="_blank" > CONSULTAR SERIES </a></td>
		</tr>
		<tr>
	...
	<form name = "formpreparar" action="#" method="POST" width="75%">
		<table align ="center" >
			<tr>
						...
						<a href="facturasdespachadasventas.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar</a> 
