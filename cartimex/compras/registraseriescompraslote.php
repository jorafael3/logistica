	...
	<div id="cuerpo2"  >
		<div align= "left" >
			<table  align= "center" border="2" cellpadding="5" cellspacing="1">
				<tr>
					<form method="POST" action="registraseriescompraslote.php" enctype="multipart/form-data" id="myform">
						<tr>
...
<div id= "cuerpo2" align= "center" >
	<div class=\"table-responsive-xs\">
		<form name = " " action="registraseriescompraslote1.php" method="POST" width="100%">
			<table  align= "center"  >
					<tr>
						<td id= "label">  
...
if ($manual==0)
												...
												foreach ($xlsx->rows() as $fila) 
													{
														if ($i == 0) 
															{
																echo "<tr><td>".$n ."</td><td  align=left>" . $fila[0]. "</td><td id= box> <input name=serie[] type=text id=serie[] value=" . $fila[1] . "></td><td id= box> <input name=codprod[] type=hidden id=codprod[] value=" . $fila[0] . "></td></tr>";
															} 
														else 
															{
																echo "<tr><td>".$n ."</td><td align=left >" . $fila[0]. "</td><td id= box> <input name=serie[] type=text id=serie[] value=" . $fila[1] . "><td id= box> <input name=codprod[] type=hidden id=codprod[] value=" . $fila[0] . "></td></td></tr>";
															}      
														$i++; 
														$n++;
													}
...
else
	{
		...
		while ( $y <= $Cantidad-1 ) 
			{
				echo "<tr><td>".$n ."</td> <td  align=left >" . $Codigo . "</td><td id= box> <input name=serie[] type=text id=serie[] value=' ' > </td> </tr>";
			$y=$y+1;
			$n=$n+1;
			}		
	}
