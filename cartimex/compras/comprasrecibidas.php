...
<div  id = "Cuerpo" >
	<div id="cuerpo2" >
					<div id = "izq" ></div>
					<div id = "centro" > <a class="titulo"> <center>   Compras/Liquidaciones Recibidas </center> </a></div>
...
<div id= "cuerpo2" align= "center" >
			...
			<div>
				<form name = "formfactura" action="trakingcompras0.php" method="POST" width="75%">
					<table align ="center" >
					<tr>
						<td id="label" >ID# </td> 
						<td id= "box"> <input name="secu" type="text" id="secu" size = "30" value= "" > </td>
						<td id= "box"> <input name="tipo" type="radio" id="tipo" size = "30" value= "COM-FA" > Compra </td>
						<td id= "box"> <input name="tipo" type="radio" id="tipo" size = "30" value= "IMP-LQ" > Liquidacion </td>
						<td id= "box"> <input name="bodega" type="hidden" id="bodega" value= "<?php echo trim($bodega) ?>"> </td>
					</tr>
					<tr>
					  <td id="etiqueta" colspan= "4">   Consultar
...
<div id="cuerpo2" align= "center">
<div>
	<form name = "formproducto" action="comprasrecibidas.php" method="POST" width="75%">
		<table align ="center" >
    	<tr>
		...
		<div class=\"table-responsive-xl\">
			...
			<form action="comprasrecibidasexcel.php" method="post"> 
