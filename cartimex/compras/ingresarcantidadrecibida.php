...
<div id="cuerpo2" align= "center" >
	<table  align ="center" > 
		<tr> <a> <strong><?php echo $codigo . "&nbsp&nbsp&nbsp&nbsp" . $nombre   ?> </strong></a></tr>
 		<form name = "forminven" action="ingresarcantidadrecibida1.php" method="POST" >
			<tr>
		...
		<tr>	 
			<td align="center" colspan= 2><a href="recepcioncompras1.php" style="text-decoration:none">Regresar</a></td>
		</tr>
	</table>
