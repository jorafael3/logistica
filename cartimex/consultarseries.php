...
<div align= "center">
	<table border=2 width=100% id= "series">
		<tr>
			...
			<td id="label4" colspan= 2>  </td>
			<td id="label5" colspan = "2" align= "right"> <a href= "reenviarseriescorreo.php?factid=<?php echo $Id ?>" > Reenviar correo series </a></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td id="td1"> <strong> Email: </strong> </td> <td id="label4"> <a> <?php echo $Mail.";".$MailDes ?>  </a> </td>
		</tr>
		<tr>
...
<div id="cuerpo2" align= "center">
	...
	<div>
		<form name = "formpreparar" action="#" method="POST" width="75%">
			<table align ="center" >
				<tr>
				  <td>	<a href="trakingfacturas1.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar</a> </td>
				</tr>
		  </table>
		</form>
