...
<div align= "center" width= 100%>
	<table border=2 width=100% id= "traking">
		...
		<tr>
			...
			<td id="td1"> <strong> Fecha <br> Factura: </strong> </td> <td id="label4"  colspan = "2"> <a> <?php echo $Fecha ?> </a> </td>
		</tr>
    	<tr>
...
?>		
	...
	<form name = "formpreparar" action="#" method="POST" width="75%">
		<table align ="center" >
			<tr>
				<td>	<a href="ingguiasfacturasventas.php" style="text-decoration:none">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regresar</a> </td>
			</tr> 
		</table>
	</form>
